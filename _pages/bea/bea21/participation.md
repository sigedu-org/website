---
title: "BEA 2026 Participation"
permalink: /bea/2026/participation/
redirect_from: /bea/21/participation/
sidebar:
  nav: "bea21"
toc: true
toc_sticky: true
...
The BEA workshop is held in conjunction with [ACL 2026](https://2026.aclweb.org) and registration is handled by them. Fees vary based on professional affiliation (academic/industry), student status, scope of attendance (workshop only vs. full conference), and mode of participation (in-person/virtual). For more detailed information and to proceed to registration, please consult the [ACL 2026 registration page](https://2026.aclweb.org/registration/).
...
The BEA workshop does not offer any volunteer opportunities. However, the ACL conference provides student volunteering opportunities for eligible applicants. Successful candidates receive a registration fee waiver. Details and application instructions are available [here](https://2026.aclweb.org/calls/volunteers/). <!--The application deadline is **June 6th, 2025**.-->

## Visa

Once you are registered via [https://2026.aclweb.org/registration/](https://2026.aclweb.org/registration/), ACL will issue an invitation letter for you that you can use for your visa application.
