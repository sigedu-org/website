...
![alt text](https://github.com/sigedu-org/website/_pages/bea/florence.jpg)


## 14th Workshop on Innovative Use of NLP for Building Educational Applications

[Workshop Description](#workshop-description)   [Shared Task](#shared-task-on-grammatical-error-correction)    [Important Dates](#important-dates)    [Submission Information](#submission-information)    [Organizing Committee](#organizing-committee)    [Program Committee](#program-committee)
...
|                        |                                                          |
| -------------          |-------------                                             |
| **Conference:**        | [ACL 2019](http://www.acl2019.org/EN/index.xhtml)        |
| **Organization:**      | Ekaterina Kochmar, Claudia Leacock, Helen Yannakoudakis, |
|                        | Ildikó Pilán, Nitin Madnani and Torsten Zesch            |
| **Contact Email:**     | bea.nlp.workshop@gmail.com                               |
| **Date:**              | August 1 or 2, 2019                                      | 
...
Christopher Bryant (University of Cambridge), Mariano Felice (University of Cambridge) and Ted Briscoe (University of Cambridge).


### IMPORTANT DATES

- **Submission Deadline: April 26, 2019 - 23:59  EST **
- Notification of Acceptance: May 24, 2019
- Camera-ready Papers Due: June 3, 2019
- Workshop: August 1 or 2, 2019


### SUBMISSION INFORMATION

We will be using the ACL Submission Guidelines for the BEA12 Workshop this year. Authors are invited to submit a full paper of up to eight (8) pages of content, plus unlimited references; final versions of long papers will be given one additional page of content (up to 9 pages) so that reviewers' comments can be taken into account. We also invite short papers of up to of up to four (4) pages of content, plus unlimited references. Upon acceptance, short papers will be given five (5) content pages in the proceedings. Authors are encouraged to use this additional page to address reviewers' comments in their final versions.
