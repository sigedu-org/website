...
***Difficulty*** contains the item difficulty measure. The measure is based on the proportion of examinees who answered the item correctly. Higher values indicate easier items (i.e., a higher proportion of examinees answered the item correctly).
...
Participants can register by filling out this form: [https://nbme.submittable.com/submit/58d9c17e-a753-4c1f-8b8a-84c1a9b8672b/bea-2024-task-data](https://nbme.submittable.com/submit/58d9c17e-a753-4c1f-8b8a-84c1a9b8672b/bea-2024-task-data)

For questions, please email Victoria Yaneva at [vyaneva@nbme.org](vyaneva@nbme.org)

Please note that it may take one business day to access the data after registration (see the Data Access section below).


## Data Access and Evaluation

Access to the data will be automatically given to registered participants on January 15. Registrations after January 15 are also allowed, however, please note that it may take one business day to access the data after registration.

The submissions need to be separate .csv files for each track named "Difficulty_Predictions.csv", and "Log_response_time_predictions.csv", respectively. Each submission should contain the item number (Item_Num) and predicted value as in the following example:

**Item_num**, **Prediction**\
**143**, **0.9**\
**423**, **0.1**

Follow this space for updates on how to submit the files closer to the submission deadline.
